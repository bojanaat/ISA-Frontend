...
export class SupplierProfileComponent implements OnInit {
  ...
  public getDetails(): void {
    ...
    this.userService.getSupplier(this.user.userResponse.id).subscribe(data =>{
      console.log(data);
      const vals = {
  ...
  submitForm(): void {
    ...
    this.userService.updateSupplier(this.user.userResponse.id, this.validateForm.value).subscribe(data => {
